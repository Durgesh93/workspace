...
export VENV_BASE="/scratch/${SBATCH_ACCOUNT}/${USER_NAME}/envbase"
...
export PROJECT_USE_PCT="$(df /project/$SBATCH_ACCOUNT --output=pcent | tail -n 1 | tr -d ' ')"
export SCRATCH_USE_PCT="$(df /scratch/$SBATCH_ACCOUNT --output=pcent | tail -n 1 | tr -d ' ')"
# ============================================================
# SLURM + GPU DETECTION
# ============================================================
